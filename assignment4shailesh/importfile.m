...
%
%  Example:
%  [SubjectID, Age, Gender, Weight, Day1, Day2, Day3] = importfile("C:\Users\gardass21\OneDrive - East Carolina University\Fall 2022\MATLAB\KINE6203AssignmentSolutions\isok_data_6803.csv", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 18-Oct-2022 12:01:44

%% Input handling

% If dataLines is not specified, define defaults
if nargin < 2 % number of input argurments = nargin, which means if we have only one input arguments (<1)
    dataLines = [2, Inf]; % infinite = inf
end
