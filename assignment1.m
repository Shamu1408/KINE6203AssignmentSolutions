...
%
% Answer: Clear all removes all items from the current workspace and
% release them from the system memory
%
...
% ver is the command used to see the list.
...
%
% Answer: A=[30:100] b=[40:110]
% R = corrcoef(A,b)
% rho - correlation coefficient, tells us relationship between two variables A and b.

% 8. What are the 2 major types of loops that MATLAB supports? What is the
% difference between them?

% Answer: for end - loop a group of statements in a loop for a specified 
% number of times i.e finite loop

% while end- evaluates expression, and repeats the
% execution of a group of statements in a loop while the expression is
% true- infinite loop
...
% Answer: NaN stands for Not-a-Number.  It represents values that are not 
% real and values obtained as a result of mathematically undefined 
% operations
% for eg: x = 0/0
% x = NaN
...
% Answer: A = [1 2 3 2 1 NaN 1 2 3 NaN];
...
y=input(prompt);
prompt="Please enter the value for z ";
z=input(prompt);
...
word = input("Please enter your thoughts" ,"s");
disp(word)
